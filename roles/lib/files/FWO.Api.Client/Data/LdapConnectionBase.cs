...
namespace FWO.Api.Data
{
    ...
    {
        [JsonProperty("ldap_connection_id")]
        ...
        [JsonProperty("ldap_pattern_length")]
        public int PatternLength { get; set; }

        [JsonProperty("ldap_search_user")]
        public string SearchUser { get; set; } = "";

        [JsonProperty("ldap_tls")]
        public bool Tls { get; set; }

        [JsonProperty("ldap_tenant_level")]
        public int TenantLevel { get; set; }

        [JsonProperty("ldap_search_user_pwd")]
        public string SearchUserPwd { get; set; } = "";

        [JsonProperty("ldap_searchpath_for_users")]
        public string? UserSearchPath { get; set; }

        [JsonProperty("ldap_searchpath_for_roles")]
        public string? RoleSearchPath { get; set; }

        [JsonProperty("ldap_searchpath_for_groups")]
        public string? GroupSearchPath { get; set; }

        [JsonProperty("ldap_write_user")]
        public string? WriteUser { get; set; }

        [JsonProperty("ldap_write_user_pwd")]
        public string? WriteUserPwd { get; set; }

        [JsonProperty("tenant_id")]
        public int? TenantId { get; set; }

        [JsonProperty("ldap_global_tenant_name")]
